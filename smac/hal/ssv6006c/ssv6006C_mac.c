        ...
        u32 *tx_len, u32 *rx_len)
{
    u32 regval = 0;
    int ret;
    ret = SMAC_REG_READ(sh, ADR_ID_LEN_THREADSHOLD2, &regval);
                                     ...
                                     u32 *ava_status)
{
    u32 regval = 0;
    int ret;
    ret = SMAC_REG_READ(sh, ADR_TAG_STATUS, &regval);
...
static void ssv6006c_set_on3_enable(struct ssv_hw *sh, bool val)
{
