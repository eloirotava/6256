...
#endif
static bool ssv6xxx_beacon_set(struct ssv_softc *sc, struct sk_buff *beacon_skb, int dtim_offset)
{
...
static void ssv6200_bcast_flush(struct ssv_softc *sc, struct ssv6xxx_bcast_txq *bcast_txq)
{
    struct sk_buff *skb;
    unsigned long flags;
#ifdef BCAST_DEBUG
